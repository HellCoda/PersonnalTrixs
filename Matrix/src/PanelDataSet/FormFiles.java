...
public class FormFiles extends JFrame implements ActionListener {

	private JComboBox<String> comboBoxFiles;
	...
	private void Formulaire() {
		...
		comboBoxFiles = new JComboBox<>(tableauxOptions);
		...
		addLabelAndComboBox("Piles :", comboBoxFiles, gbc, 0);
		...
		StyleMethode.StyleComboBox(comboBoxFiles);
