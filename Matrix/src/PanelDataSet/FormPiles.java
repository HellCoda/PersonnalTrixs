...
public class FormPiles extends JFrame implements ActionListener {

	private JComboBox<String> comboBoxPiles;
	...
	private void Formulaire() {
		...
		comboBoxPiles = new JComboBox<>(tableauxOptions);
		...
		addLabelAndComboBox("Piles :", comboBoxPiles, gbc, 0);
		...
		StyleMethode.StyleComboBox(comboBoxPiles);
