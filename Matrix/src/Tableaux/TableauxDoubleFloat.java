...
public class TableauxDoubleFloat implements ITableauxDoubleFloat, Affichage {
	...
	public TableauxDoubleFloat(int taille, int sousTaille) {
	...
	@Override
	public void ajouterLigne(ValeurFloat[] ligne) {
		// TODO Auto-generated method stub
